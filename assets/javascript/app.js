...
function displaySearchResults() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + search + "&api_key=lErOc7LwRP3qB5bErzQyb5aBr0l8GXRs&limit=10";

    // Perfoming an AJAX GET request
    $.ajax({
        url: queryURL,
        method: "GET"
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            if (results[i].rating !== "r") {
                ...
                var p = $("<p>").text('"' + results[i].title + '"' + " Rating: " + rating);
